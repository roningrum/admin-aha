...
class DashboardPostController extends Controller
{
    ...
    public function update(Request $request, Post $post)
    {
        ...
        if($request->hasFile('img_blog')){
            ...
            $img_path = public_path('storage/assets/image/'.$filename);
            ...
            $img->save(public_path('storage/assets/image/').$filename);
            $image = 'assets/image/' . $img->basename;
            $validatedData['img_blog'] = $image;
    ...
    {
        if($post->img_blog){
            Storage::delete('public/'.$post->img_blog);
        }
