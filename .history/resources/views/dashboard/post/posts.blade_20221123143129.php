    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <h5>Apakah kamu yakin menghapus post ini?</h5>
        </div>
                                        ...
                                        @foreach ($posts as $post)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" class="btn btn-danger deletePost" value="{{ $post->slug }}" data-toggle="modal" data-target="#exampleModalCenter"><i class="far fa-trash-alt"></i></button>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
